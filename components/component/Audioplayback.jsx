...
export default function Audioplayback(props) {
  return (
    <div
      className="fixed inset-x-0 bottom-0 bg-background border-t border-muted shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1),0_-2px_4px_-2px_rgba(0,0,0,0.1)] flex justify-center items-center">
      <div className="container px-4 py-3 flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <div className="text-sm text-muted-foreground mt-2">0:00 / 0:{props.time} seconds</div>
